...
export default function PaymentResultPage() {
  ...
  return (
    <View className={`payment-result ${result}`}>
      <View className='result-mark'><View className='result-ring'>{result === 'success' ? <Text>✓</Text> : <View className='pending-dot' />}</View><View className='orbit orbit-one' /><View className='orbit orbit-two' /></View>
      ...
      <View className='result-actions'>
        {result === 'pending' && <Button loading={checking} onClick={verify}>重新查询</Button>}
